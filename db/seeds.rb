...
shelter1 = Shelter.create(name: "", address_id: )
shelter2 = Shelter.create(name: "", address_id: )
shelter3 = Shelter.create(name: "", address_id: )
shelter4 = Shelter.create(name: "", address_id: )
shelter5 = Shelter.create(name: "", address_id: )
shelter6 = Shelter.create(name: "", address_id: )

address1 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address2 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address3 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address4 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address5 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address6 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address7 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address8 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
address9 = Address.create(street: "", city: "", state: "", zip:"", user_id: , shelter_id: )
