...
user1 = User.create(username: "iamcatdad", email: "maskiella@gmail.com", first_name: "Andy", last_name: "Maskiell", password: "catz4lyf3")
user2 = User.create(username: "bradfizzle", email: "bradfizzle@gmail.com", first_name: "Brad", last_name: "Demarest", password: "iheartplatez")
user3 = User.create(username: "comiccalvin", email: "calvin@gmail.com", first_name: "Calvin", last_name: "Watterson", password: "snowballfightz")
user4 = User.create(username: "chuckyb", email: "charles.brown@gmail.com", first_name: "Charlie", last_name: "Brown", password: "goodgrief")
...
address1 = Address.create(street1: "29 Colburne Rd.", street2: "Apt. 2", city: "Brighton", state: "MA", zip: "02135")
address2 = Address.create(street1: "", street2: "", city: "Rochester", state: "NY", zip: "14618")
address3 = Address.create(street1: "", street2: "", city: "Chagrin", state: "OH", zip: "44022")
address4 = Address.create(street1: "", street2: "", city: "Saint Paul", state: "MN", zip: "55101")
address5 = Address.create(street1: "250 Florida St.", street2: "", city: "San Francisco", state: "CA", zip: "94103")
address6 = Address.create(street1: "200 Centre St.", street2: "", city: "New York", state: "NY", zip: "10013")
address7 = Address.create(street1: "142 Kindness Ct.", street2: "", city: "Burlington", state: "VT", zip: "05403")
address8 = Address.create(street1: "99 Victor Rd.", street2: "", city: "Fairport", state: "NY", zip: "14450")
address9 = Address.create(street1: "1845 Pontius Ave.", street2: "", city: "Los Angeles", state: "CA", zip: "90025")
address10 = Address.create(street1: "629 Oakland Park Ave.", street2: "", city: "Columbus (London)", state: "OH", zip: "43214")
